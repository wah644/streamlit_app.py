...
if st.session_state.variant_count > 0:
    ...
    if st.button("Generate Overall AI Summary"):
        with st.spinner("Analyzing all variants..."):
            ...
            all_variants_summary += f"Additional Rules: Try to consider the overall phenotype terms rather than 1 only. Prioritize ACMG pathogenic classificaiton. Reply in the format: Numbered Rankings witha  short paragraph explanation for each rank, finally end with a conclusion \n"
