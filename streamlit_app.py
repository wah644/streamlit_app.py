...
if user_input:
    ...
    if flag == True:
        ...
        def highlight_classification(row):
            color_map = {
                "Definitive": "background-color: rgba(119, 221, 119, 0.2)",  # Pastel Green with 65% transparency
                "Disputed": "background-color: rgba(255, 182, 182, 0.2)",  # Pastel Red with 65% transparency
                "Moderate": "background-color: rgba(152, 255, 152, 0.2)",  # Pastel Light Green with 65% transparency
                "Limited": "background-color: rgba(255, 255, 204, 0.2)",  # Pastel Yellow with 65% transparency
                "No Known Disease Relationship": "",
                "Strong": "background-color: rgba(102, 204, 102, 0.2)",  # Pastel Dark Green with 65% transparency
                "Refuted": "background-color: rgba(255, 182, 182, 0.2)"  # Pastel Red with 65% transparency
            }
