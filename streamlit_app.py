...
if user_input:
    ...
    if flag == True:
        ...
        def highlight_classification(row):
            color_map = {
                "Definitive": "background-color: rgba(0, 128, 0, 0.9)",  # Green with 65% transparency
                "Disputed": "background-color: rgba(255, 0, 0, 0.9)",  # Red with 65% transparency
                "Moderate": "background-color: rgba(144, 238, 144, 0.9)",  # Light Green with 65% transparency
                "Limited": "background-color: rgba(255, 255, 0, 0.9)",  # Yellow with 65% transparency
                "No Known Disease Relationship": "",
                "Strong": "background-color: rgba(0, 128, 0, 0.9)",  # Dark Green with 65% transparency
                "Refuted": "background-color: rgba(255, 0, 0, 0.9)"  # Red with 65% transparency
            }
